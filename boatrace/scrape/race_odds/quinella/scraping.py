...
from boatrace.scrape.race_odds.quinella import OddsQuinellaConst
...
class OddsQuinellaScraping:
    ...
    def scrape(self, race_id: int, stadium_id: int, date: datetime) -> list[dict]:
        ...
        _, quinella_tbody_soup = soup.find_all("tbody", class_=OddsQuinellaConst.tbody_class)
        ...
        for tr_soup in tr_soups:
            ...
            for idx_1st in range(TOOL_PARAM.n_racer):
                ...
                if odds:
                    scrape_datas.append(OddsQuinellaColumns().cast([
                        race_id,
                        stadium_id,
                        date,
                        bet_no,
